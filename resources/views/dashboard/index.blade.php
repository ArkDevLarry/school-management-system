        ...
        <div class="container-fluid">
            <div class="row clearfix row-deck">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            ...
                            <a href="{{route('dashboard.employee')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.library')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('dashboard.holiday')}}" class="my_sort_cut text-muted">
                                    ...
                                    <table class="table card-table table-vcenter text-nowrap table-striped mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar1.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar2.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar3.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar4.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar5.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar6.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>Claire Peters</div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w40">
                                                    <div class="avatar">
                                                        <img class="avatar" src="backend/assets/images/xs/avatar7.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>Claire Peters</div>
